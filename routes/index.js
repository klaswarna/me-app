...
router.get('/', function(req, res, next) {
    const data = {
        data: {
            msg: [
                "Hej. Jag heter Klas W. Detta är min sista dbwebb-kurs. Det känns lite sorgligt känns det för de har varit mycket givande, men det känns desto roligare att snart vara klar med hela utbildningen",
